...
import util  # Make sure util.py is in the same directory or reachable from Python path
...
class App:
    ...
    def find_camera_index(self):
        for i in range(10000):  # Try indices from 0 to 9
...
# name = self.entry_text_register_new_user.get(1.0, "end-1c")
        ...
        images_list = [...]  # Your list of NumPy arrays here
